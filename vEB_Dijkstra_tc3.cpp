...
{ 
   ...
   /* fscanf(fptr,"%d", &src);    
    ...
    addEdge(graph,8, 11, 4);
    addEdge(graph,9, 10, 2);
    addEdge(graph,10, 11, 3);
    addEdge(graph,10, 12, 7);
    addEdge(graph,11, 12, 6);
    addEdge(graph,11, 13, 8);
    addEdge(graph,11, 14, 2);
    addEdge(graph,12, 13, 6);
    addEdge(graph,13, 14, 7);
    addEdge(graph,13, 15, 9);
    addEdge(graph,13, 16, 12);
    addEdge(graph,14, 15, 3);
    addEdge(graph,15, 16, 9);
    addEdge(graph,15, 17, 3);
    addEdge(graph,16, 17, 8);
    addEdge(graph,16, 18, 5);
    addEdge(graph,17, 18, 6);
